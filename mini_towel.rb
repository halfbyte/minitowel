  ...
  module MiniTowel::Views
    def layout
      html do
        head do
          ...
          link :rel => "stylesheet", :href => R(Static, 'stylesheets/style.css'), :type => "text/css", :media => 'screen'
          script :src => R(Static, "javascripts/prototype.js"), :type => 'text/javascript'
          script :src => R(Static, "javascripts/scriptaculous.js"), :type => 'text/javascript'          
          script :src => R(Static, "javascripts/application.js"), :type => 'text/javascript'          
        ...
        body do
          div.header! do
            ...
            img :src => R(Static, 'images/spinner.gif'), :id => 'spinner', :style => 'display:none'
    ...
    def list      
      ul.localNavigation.clearfix do
        li do
          a :href => R(New) do 
            img :src => R(Static, "images/new.png"), :alt => 'New', :title => 'New', :class => 'imageButton'
          end
        end
      ...
      ul :class => "cards clearfix corkboard size#{@state[:zoom_level]||1}", :id => 'cardList' do
        ...
        ul.cardTools do
          li do
            a :href => R(Edit, entity.id) do
              img :src => R(Static, "images/edit.png"), :alt => 'Edit', :title => 'Edit', :class => 'imageButton'
            end
          end
          li do
            a :href => R(Edit, entity.id) do
              img :src => R(Static, "images/delete.png"), :alt => 'Delete', :title => 'Delete', :class => 'imageButton'
            end
          end
        end
      end
    ...
    def _form      
      p do
        ...
        input :type => 'text', :name => 'entity[title]', :value => @entity.title, :size => 40, :class => 'huge', :id => 'entity_title'
      end
      p do
        label :for => 'entity_description' do
          self << "Description "
        end
        textarea :name => 'entity[description]', :cols => 70, :rows => 10, :id => 'entity_description' do
          @entity.description
        end
      end   
      p do
        ...
        input :type => 'text', :name => 'entity[effort]', :value => @entity.effort, :size => 5, :id => 'entity_effort'
      end
    end
  end
